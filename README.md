...
gplot(web, gmode="twomode", usearrows="FALSE", mode="kamadakawai", main="NÃ³s centrais", object.scale = 0.03)

#Fruchterman Reignold - melhor para ver modulos
gplot(web, gmode="twomode", usearrows="FALSE", mode="fruchtermanreingold", main="MÃ³dulos", object.scale = 0.03)
